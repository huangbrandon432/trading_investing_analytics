...
def plot_buysell_points_line(ticker, tradesdf, crypto = 'no', start_date = '', end_date = '', interval = '1d', instrument = 'Stock'):
    ...
    for i in range(len(trade_history)):
        ...
        if instrument == 'Stock':
            ...
            price = ticker_hist[ticker_hist['Date'] == trade_date]['Close'].item()
